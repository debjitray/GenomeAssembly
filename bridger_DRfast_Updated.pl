...
#system "sh $scriptpath/bbmap/bbduk.sh Xmx1g in1=PE_R1.fq.gz in2=PE_R2.fq.gz out1=PE_clean1.fq out2=PE_clean2.fq ref=$scriptpath/bbmap/resources/nextera.fa.gz ktrim=r k=21 mink=11 hdist=1 tpe tbo";
#system "sh $scriptpath/bbmap/bbduk.sh Xmx1g in1=MP_R1.fq.gz in2=MP_R2.fq.gz out1=MP_clean1.fq out2=MP_clean2.fq ref=$scriptpath/bbmap/resources/nextera_LMP_adapter.fa.gz ktrim=r k=21 mink=11 hdist=1 tpe tbo";
#system "sh $scriptpath/bbmap/splitnextera.sh in1=MP_clean1.fq in2=MP_clean2.fq out=MP.fq outf=PE.fq outu=Unknown.fq outs=Single.fq mask=t";
#system "perl $scriptpath/interlacedSplitter.pl MP.fq";
